...
class AndroidPermissionManager(private val context: Context) : PermissionManager {
    ...
    private fun voiceAuthStatus(): CapabilityStatus {
        ...
        return when { store.get("profile") != null && store.get("enabled") == "true" -> CapabilityStatus.ON; store.get("profile") != null -> CapabilityStatus.OFF; else -> CapabilityStatus.NOT_ENROLLED }
    }
