...
@Composable
private fun SettingsScreen(app: UstadApplication, onAiProviders: () -> Unit, onVoice: () -> Unit) {
    ...
    Column(Modifier.fillMaxSize().verticalScroll(rememberScrollState()).padding(20.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
        ...
        Button(onClick = onAiProviders, modifier = Modifier.fillMaxWidth()) { Text("AI PROVIDER MANAGER") }; Button(onClick = onVoice, modifier = Modifier.fillMaxWidth()) { Text("VOICE SETTINGS") }
