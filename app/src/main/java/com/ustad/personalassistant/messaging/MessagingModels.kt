...
enum class MessageState { IDLE, RESOLVING_CONTACT, PREPARING_MESSAGE, WAITING_FOR_CONFIRMATION, WAITING_FOR_USER_SEND, SENDING, VERIFYING, SUCCESS, FAILED, CANCELLED }
